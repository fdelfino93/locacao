# Criar funcao limpa de atualizar_contrato
def clean_atualizar_contrato(contrato_id, **kwargs):
...
if __name__ == "__main__":
    ...
    resultado = clean_atualizar_contrato(1, **dados_teste)
